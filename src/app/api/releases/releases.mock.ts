...
export const releases: Release[] = [
  ...
  {
    theme: ["text-neutral-300", "bg-neutral-900"],
    title: "Eigenräume",
    cover: {
    ...
    date: "May 14, 2019",
    about: `<b>“Eigenräume”</b> is the first (and incomplete) version of the concept album, which featured the main tracks of the full album in their standalone versions. To get the full listening experience, listen to the full version below!`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    date: "Sep 09, 2019",
    about: `<b>“Eigenräume (Extended Edition)”</b> is 2019's main Zoomoid release, with 11 tracks (again), intro and outro, and seamless blending of tracks (at least on the first 7 tracks)! It also features 3 tracks that were written after the original concept album was created, but seemed to fit the overall context. In particular, Zoomoid is proud of <b>“Outer Space”</b>`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    date: "Nov 1, 2019",
    about: `“In <b>December, 2018</b>, returning from a night of party in Münster, Germany, via train, I travelled through several stations I never had been to before.
    The <b>charismatic voice of Ingo Ruff</b>, freshly fallen snow that covered lonely fields along the way, and a slight hangover of the tequila from the previous
    ...
    It's real, it's honest, <b>it's got sharp edges</b> and it's certainly different to my other work in that year. Yet, it's a favourite of <b>a lot of people for exactly that reason.</b>”
    — Zoomoid`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    date: "Dec 13, 2019",
    about: `<b>“301 Permanently Moving”</b> is a nerdy joke and tribute to the HTTP protocol, which drives the internet, where the status 301 indicates that a web page has moved permanently. The tracks on this EP have the potential to get you moving, with <b>hard-driving Techno</b> and a reworked version of Outer Space!`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    date: "May 1, 2020",
    about: `<b>“Shades Of Yellow”</b> is an emotional ode to the relationship I have with the color <b>Yellow</b> and the closest thing I've come to writing a <b>love song</b>. Both tracks move me in a very special way, and there are many many memories attached to them. I know some other people do as well and <b>I hope, you can, too.</b>`,
    listen: [
      {
        title: "Spotify",
  ...
  {
    theme: ["text-gray-200", "bg-gray-950"],
    title: "Voyager",
    cover: {
      url: "/img/voyager.jpg",
    },
    anchor: "voyager",
    date: "Oct 30, 2020",
    about: `<b>“Voyager”</b> is a journey away from earth into the darkness of space to discover the beauty of emptiness both inside and around you. Let yourself be taken away by an hour of listening experience of <b>many-faced techno and trance sounds</b>. Voyager is the most holistic Zoomoid release yet, and I'm very proud of it!`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    anchor: "sehnsucht",
    date: "Mar 19, 2021",
    about: `<b>“Sehnsucht”</b> is a a 5-track <b>acoustic instrumental album</b>, featuring intimate instruments and a huge load of emotions. I wrote those tracks with the emotion of missing out and wishing for old times and new times at the same time, trying to express what I've been feeling for the last months. I <b>love them all very dearly.</b>`,
    listen: [
      {
        title: "Spotify",
  ...
  },
  {
    ...
    title: "Im Schatten <wbr>Der Nacht",
    cover: {
      url: "/img/im_schatten_der_nacht.jpg",
    },
    anchor: "im-schatten-der-nacht",
    date: "Dec 17, 2021",
    about: `<b>“Im Schatten Der Nacht”</b> is a small driving Techno EP that comes to live when leaving the club <b>early in the morning</b> and heading home while still buzzing from the night before.`,
    listen: [
      {
        title: "Spotify",
