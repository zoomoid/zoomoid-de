  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 bottom-0 right-0 w-full h-full z-0 isolate">
        <div className="absolute top-0 left-0 bottom-0 right-0 w-full h-full bg-neutral-900 bg-opacity-50 z-10" />
        <div
      ...
      <div className="container max-w-screen-2xl lg:grid grid-cols-2 gap-16 relative z-10">
        ...
        <div className="">
          <Image src={im_schatten_der_nacht_cover} placeholder="blur" alt="" />
        </div>
