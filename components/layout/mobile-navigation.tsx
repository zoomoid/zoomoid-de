...
type MobileNavigationProps = React.PropsWithChildren<{
...
export default function MobileNavigation({ navigation }: MobileNavigationProps) {
  ...
  return (
    <div
      className={` text-white container max-w-screen-2xl py-2 md:hidden absolute top-0 left-0 right-0 z-50 transition-colors`}
    >
      ...
      {showNav && (
        <div
          className={`bg-black fixed backdrop-blur-3xl top-0 left-0 bottom-0 right-0 z-50 h-screen w-screen`}
        >
