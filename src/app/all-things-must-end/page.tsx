  ...
  return (
    <div>
      ...
      <p>
        ...
        the idea for Zoomoid, All Things Must End marks the final step of me as
      ...
      <p>
        When my mental health got worse, I distanced myself from reality and
        from myself. That also meant distancing myself from being Zoomoid, the
        artist. It became harder and harder to write and compose new music. I
        took ever-longer breaks from it.
      </p>
      <p>
      ...
      <p>I think, for once, at least in some part, I succeeded.</p>
      <p>
        All Things Must End is my last album. What comes afterwards is pretty
